...
import com.baidu.aip.face.turnstile.manager.DegreeManager;
...
public class DetectActivity extends AppCompatActivity implements ViewTreeObserver.OnGlobalLayoutListener,ICameraControl.CameraListener  {
...
//         previewView.setMirrored(false);
        ...
        //  previewView.setMirrored(false);
        DegreeManager.newInstance().handleDegree(faceDetectManager, cameraImageSource, 270, CameraView.ORIENTATION_PORTRAIT);
    ...
    private void showFrame(FaceFilter.TrackedModel model) {
        ...
        if (model != null) {
            ...
            float t = rectF.width() / 4;
            rect.left = rectF.left + t;
            rect.right = rectF.right - t;
            t = rectF.height() / 4;
            rect.bottom = rectF.bottom - t;
            rect.top = rectF.top + t;
